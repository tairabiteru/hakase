...
INSTALLED_APPS = [
    ...
    "hakase.mvc.discord",
    "hakase.mvc.starboard",
    "hakase.mvc.internal",
    "hakase.mvc.reminders",
]
...
MIDDLEWARE = [
    ...
    "hakase.mvc.discord.middleware.BotInjectorMiddleware"
]

SESSION_ENGINE  = "django.contrib.sessions.backends.file"
SESSION_FILE_PATH = conf.temp

ROOT_URLCONF = "hakase.mvc.core.urls"

TEMPLATES = [
    {
        "BACKEND": "django.template.backends.django.DjangoTemplates",
        "DIRS": [os.path.join(conf.root_dir, "hakase/mvc/core/templates")],
        "APP_DIRS": True,
        "OPTIONS": {
            "context_processors": [
...
WSGI_APPLICATION = "hakase.mvc.core.wsgi.application"
